...
namespace TeamCafe.Client
{
    public partial class AccountProfile : Form
    {
        ...
        public AccountProfile(string idStaff, StreamWriter writer)
        {
            InitializeComponent();
        ...
        void LoadProfile(string idStaff)
        {
            try
            {
                string connectionString = "Data Source=Yenly\\SQLEXPRESS;Initial Catalog=TeamCafe17;Integrated Security=True";
